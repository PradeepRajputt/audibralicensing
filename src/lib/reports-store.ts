...
let mockReports: Report[] = [
    ...
    { id: 'report_initial_2', creatorId: 'user_creator_123', creatorName: 'Sample Creator', suspectUrl: 'https://instagram.com/p/reel456', platform: 'instagram', status: 'rejected', submitted: new Date(Date.now() - 6048e5).toISOString(), reason: 'They used my background music without credit.', originalContentUrl: 'https://youtube.com/watch?v=original456', originalContentTitle: 'My Travel Blog - Summer in Italy' }
];
