    ...
    <div className="flex flex-col min-h-screen items-center justify-center p-4">
      <div className="flex items-center gap-4 mb-8">
       ...
       <p className="max-w-xl text-center text-muted-foreground mb-12">
          This is a simplified navigation hub for development. In a real application, this would be a login/registration flow.
        </p>
          ...
          <Card className="h-full text-left transition-all duration-300 hover:border-accent hover:shadow-lg hover:-translate-y-1">
            <CardHeader>
              ...
              <CardDescription className="text-center pt-2">
                Simulate logging in as a content creator. Access your analytics, monitor your content, and manage copyright claims.
              </CardDescription>
            </CardHeader>
            <CardContent>
