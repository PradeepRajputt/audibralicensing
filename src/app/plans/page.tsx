				...
				<div className="flex items-center gap-4 bg-yellow-100/90 border border-yellow-400 text-yellow-900 rounded-xl px-6 py-4 shadow-md">
					...
					<div className="flex-1">
						...
						<div className="text-sm">
							If you have already chosen a plan and are an existing CreatorShield user, please log in to your account instead of selecting a new plan.
						</div>
					</div>
					<button
				...
				<div className="fixed inset-0 flex items-center justify-center z-50 bg-black/60">
					<div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full flex flex-col items-center">
						...
						<p className="text-gray-700 text-center mb-4">
							You need to <b>register</b> and <b>login</b> before you can choose a plan and start your CreatorShield subscription.
						</p>
				...
				{PLANS.map((plan) => (
					...
					>
						...
						<ul className="mb-6 space-y-2 w-full">
							<li className="flex items-center text-gray-100 text-base">
								<span className="mr-2 text-green-400">✔️</span> All premium features
							</li>
							<li className="flex items-center text-gray-100 text-base">
								<span className="mr-2 text-green-400">✔️</span> Priority support
							</li>
							<li className="flex items-center text-gray-100 text-base">
								<span className="mr-2 text-green-400">✔️</span> Secure payments
							</li>
						</ul>
